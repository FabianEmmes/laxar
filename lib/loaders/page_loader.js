...
define( [
   ...
   function loadPageRecursively( self, pageName, extensionChain ) {
      ...
      return load( self, pageSelfLink )
         ...
         .then( function() {
            return processCompositions( self, page, [], page, pageName );
         } )
         .then( function() {
   ...
   function processCompositions( self, page, compositionChain, topPage, topPageName ) {
      ...
      object.forEach( page.areas, function( widgets ) {
         ...
         for( var i = widgets.length - 1; i >= 0; --i ) {
            ( function( widgetSpec, index ) {
               ...
               if( widgetSpec.enabled !== false && has( widgetSpec, 'widget' ) ) {
               ...
               if( has( widgetSpec, 'composition' ) ) {
                  ...
                  promise = promise
                     ...
                     .then( function( composition ) {
                        ...
                        pageTooling.setCompositionDefinition( topPageName, widgetSpec.id, composition, pageTooling.COMPACT );
                        console.log( 'setting compact composition', object.deepClone( composition ) );
                        return processCompositions( self, composition, chain, topPage, topPageName )
                           .then( function() {
      ...
      if( page === topPage ) {
         console.log( 'CLOG: setting compact page definition! ', object.deepClone( page ) ); // :TODO: DELETE ME
